...
- **MasterGo D2C Think-Stage Integration (v9.1.0)**: Added `DA-7` design rule to enforce `d2c-spec.json` compilation and design-sheet integration when MasterGo design content is provided.
