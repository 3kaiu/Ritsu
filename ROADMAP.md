...
| 1c | 替代加载机制：将 SKILL.md 编译为 Cursor rules / Cline rules / Copilot instructions | 中（1 周） |
...
| 3b | 修复记忆系统：补全向量索引写入、消除重复 tokenize、记忆增加 file_refs/symbol_refs 链接 | 小（1-2 天） |
...
| 6c | Slack/Teams Webhook 通知 | 小（1-2 天） |
