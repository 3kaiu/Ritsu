...
│   ├── ctx-protocol.md         # 情景记忆持久化协议（.ritsu/ctx-{YYYY-MM}.jsonl + 月度摘要）
...
| 版本   | 核心变更                                                                                                                                                                                                                                                                                                                                                                |
| ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v3.3.1 | **LLM 底层架构深度优化**：skill-common-steps.md 内联关键协议消除 3 层间接引用；8 个 SKILL.md 增加 token_budget + required_sections + Step Complete 锚点；mcp-tools.yaml 增加结构化调用模板；context-loader.md 增加按需加载 section 映射；ctx-protocol.md 增加月度摘要机制；Handoff 增加 append-only Changelog。                                                         |
