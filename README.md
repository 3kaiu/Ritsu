...
| 版本   | 核心变更                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v3.5.0 | **MCP Server 运行时 (Runtime Implementation)**：新增 runtime/ 目录（TypeScript MCP Server），将 mcp-tools.yaml 协议声明编译为可执行 MCP 工具服务；9 个工具完整运行时实现（ritsu_emit_event/ritsu_read_ctx/ritsu_write_artifact/ritsu_get_changed_files/ritsu_get_diff/ritsu_grep_identifier/ritsu_run_quality_gates/ritsu_list_artifacts/ritsu_retrieve_memory）；ctx-event-schema.json + ajv 运行时校验；correlation_id 生成/继承行为闭环；route 增加 transition_event 写入；stdio transport 支持 IDE 集成（Cursor/Windsurf/Claude Desktop）。                                                                                                                                                                        |
